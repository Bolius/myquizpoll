...
$TCA['tx_myquizpoll_question'] = array (
	...
	'feInterface' => $TCA['tx_myquizpoll_question']['feInterface'],
	'columns' => array (
		't3ver_label' => array (		
...
$TCA['tx_myquizpoll_voting'] = array (
	...
	'feInterface' => $TCA['tx_myquizpoll_voting']['feInterface'],
	'columns' => array (
		'sys_language_uid' => array (		
			'exclude' => 1,
			'label'  => 'LLL:EXT:lang/locallang_general.xml:LGL.language',
...
$TCA['tx_myquizpoll_result'] = array (
	...
	'feInterface' => $TCA['tx_myquizpoll_result']['feInterface'],
	'columns' => array (
		'sys_language_uid' => array (		
			'exclude' => 1,
			'label'  => 'LLL:EXT:lang/locallang_general.xml:LGL.language',
...
$TCA['tx_myquizpoll_relation'] = array (
	...
	'feInterface' => $TCA['tx_myquizpoll_relation']['feInterface'],
	'columns' => array (
		'sys_language_uid' => array (		
			'exclude' => 1,
			'label'  => 'LLL:EXT:lang/locallang_general.xml:LGL.language',
...
$TCA['tx_myquizpoll_category'] = array (
	...
	'feInterface' => $TCA['tx_myquizpoll_category']['feInterface'],
	'columns' => array (
		'name' => array (		
			'exclude' => 0,		
